...
<body>
        ...
        <div class="content-grid">
            ...
            <div class="glass-card details-card">
                <div class="card-title">
                    👤 Profile Details
                    <span style="margin-left: auto; font-size: 12px; color: rgba(255,255,255,0.2);">ID:
                        #{{ $teacher->id }}</span>
                </div>
                ...
                <div class="detail-row"
                    style="flex-direction: column; gap: 10px; align-items: stretch; padding-bottom: 0;">
            ...
            <div class="glass-card schedule-card">
                ...
                <div class="empty-state">
                    ...
                    <p style="font-size: 12px; color: rgba(255,255,255,0.15); margin-top: 4px;">Contact admin to create
                        your schedule</p>
                </div>
                @endif
            </div>
    ...
    <div class="glass-card" style="padding: 24px 32px; margin-bottom: 28px;">
        <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 16px;">
            <div>
                ...
                <p style="font-size: 13px; color: rgba(255,255,255,0.35); margin-top: 4px;">
                    ...
                    @else
                    <span style="color: #fca5a5;">❌ You are marked as unavailable
                        ({{ $teacher->unavailable_reason ?? 'No reason provided' }})</span>
                    @endif
                </p>
            </div>
            <div>
                @if($teacher->is_available)
                <button onclick="showUnavailableForm()" class="action-btn action-btn-secondary"
                    style="background: rgba(239, 68, 68, 0.12); color: #fca5a5; border-color: rgba(239, 68, 68, 0.2);">
                    ❌ Mark as Unavailable
                </button>
                @else
        ...
        <div id="unavailableForm"
            style="display: none; margin-top: 20px; padding-top: 20px; border-top: 1px solid rgba(255,255,255,0.06);">
            <form method="POST" action="{{ route('teacher.mark-unavailable') }}">
                @csrf
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                    <div>
                        <label
                            style="color: rgba(255,255,255,0.5); font-size: 13px; display: block; margin-bottom: 6px;">Reason
                            for absence</label>
                        <input type="text" name="reason" placeholder="e.g., Sick leave, Personal work"
                            style="width: 100%; padding: 10px 14px; background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.08); border-radius: 12px; color: white; font-size: 14px;">
                    </div>
